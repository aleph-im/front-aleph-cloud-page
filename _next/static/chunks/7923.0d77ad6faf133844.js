...
`,wui_token_list_item_decorate=function(e,t,o,i){var n,r=arguments.length,a=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(a=(r<3?n(a):r>3?n(t,o,a):n(t,o))||a);return r>3&&a&&Object.defineProperty(t,o,a),a};let R=class extends P.oi{constructor(){super(),this.observer=new IntersectionObserver(()=>void 0),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){if(!this.visible)return null;let e=this.amount&&this.price?r.C.multiply(this.price,this.amount)?.toFixed(3):null;return P.dy`
      <wui-flex alignItems="center">
        ...
        <wui-flex flexDirection="column" gap="1">
          ...
          <wui-flex justifyContent="space-between">
            ...
            ${this.amount?P.dy`<wui-text variant="sm-regular" color="secondary">
                  ${r.C.formatNumberToLocalString(this.amount,5)}
                </wui-text>`:null}
          </wui-flex>
        </wui-flex>
      </wui-flex>
    `}visualTemplate(){return this.imageError?P.dy`<wui-flex class="token-item-image-placeholder">
        <wui-icon name="image" color="inherit"></wui-icon>
      </wui-flex>`:this.imageSrc?P.dy`<wui-image
        width="40"
        height="40"
        src=${this.imageSrc}
        @onLoadError=${this.imageLoadError}
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};R.styles=[A.ET,A.ZM,Y],wui_token_list_item_decorate([(0,I.Cb)()],R.prototype,"imageSrc",void 0),wui_token_list_item_decorate([(0,I.Cb)()],R.prototype,"name",void 0),wui_token_list_item_decorate([(0,I.Cb)()],R.prototype,"symbol",void 0),wui_token_list_item_decorate([(0,I.Cb)()],R.prototype,"price",void 0),wui_token_list_item_decorate([(0,I.Cb)()],R.prototype,"amount",void 0),wui_token_list_item_decorate([(0,I.SB)()],R.prototype,"visible",void 0),wui_token_list_item_decorate([(0,I.SB)()],R.prototype,"imageError",void 0),R=wui_token_list_item_decorate([(0,B.M)("wui-token-list-item")],R),o(22584);var E=D.iv`
  :host {
    width: 100%;
  }
...
`;let j=class extends P.oi{render(){return P.dy`
      <wui-flex alignItems="center">
    ...
    `}};j.styles=[A.ET,E],j=function(e,t,o,i){var n,r=arguments.length,a=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(a=(r<3?n(a):r>3?n(t,o,a):n(t,o))||a);return r>3&&a&&Object.defineProperty(t,o,a),a}([(0,B.M)("wui-token-list-item-loader")],j);var L=w.iv`
  :host {
...
`,w3m_swap_select_token_view_decorate=function(e,t,o,i){var n,r=arguments.length,a=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(a=(r<3?n(a):r>3?n(t,o,a):n(t,o))||a);return r>3&&a&&Object.defineProperty(t,o,a),a};let U=class extends i.oi{constructor(){super(),this.unsubscribe=[],this.targetToken=s.RouterController.state.data?.target,this.sourceToken=l.nY.state.sourceToken,this.sourceTokenAmount=l.nY.state.sourceTokenAmount,this.toToken=l.nY.state.toToken,this.myTokensWithBalance=l.nY.state.myTokensWithBalance,this.popularTokens=l.nY.state.popularTokens,this.suggestedTokens=l.nY.state.suggestedTokens,this.tokensLoading=l.nY.state.tokensLoading,this.searchValue="",this.unsubscribe.push(l.nY.subscribe(e=>{this.sourceToken=e.sourceToken,this.toToken=e.toToken,this.myTokensWithBalance=e.myTokensWithBalance,this.popularTokens=e.popularTokens,this.suggestedTokens=e.suggestedTokens,this.tokensLoading=e.tokensLoading}))}async firstUpdated(){await l.nY.getTokenList()}updated(){let e=this.renderRoot?.querySelector(".suggested-tokens-container");e?.addEventListener("scroll",this.handleSuggestedTokensScroll.bind(this));let t=this.renderRoot?.querySelector(".tokens");t?.addEventListener("scroll",this.handleTokenListScroll.bind(this))}disconnectedCallback(){super.disconnectedCallback();let e=this.renderRoot?.querySelector(".suggested-tokens-container"),t=this.renderRoot?.querySelector(".tokens");e?.removeEventListener("scroll",this.handleSuggestedTokensScroll.bind(this)),t?.removeEventListener("scroll",this.handleTokenListScroll.bind(this)),clearInterval(this.interval)}render(){return i.dy`
    ...
    `:null}onSearchInputChange(e){this.searchValue=e.detail}handleSuggestedTokensScroll(){let e=this.renderRoot?.querySelector(".suggested-tokens-container");e&&(e.style.setProperty("--suggested-tokens-scroll--left-opacity",w.kj.interpolate([0,100],[0,1],e.scrollLeft).toString()),e.style.setProperty("--suggested-tokens-scroll--right-opacity",w.kj.interpolate([0,100],[0,1],e.scrollWidth-e.scrollLeft-e.offsetWidth).toString()))}handleTokenListScroll(){let e=this.renderRoot?.querySelector(".tokens");e&&(e.style.setProperty("--tokens-scroll--top-opacity",w.kj.interpolate([0,100],[0,1],e.scrollTop).toString()),e.style.setProperty("--tokens-scroll--bottom-opacity",w.kj.interpolate([0,100],[0,1],e.scrollHeight-e.scrollTop-e.offsetHeight).toString()))}filterTokensWithText(e,t){return e.filter(e=>`${e.symbol} ${e.name} ${e.address}`.toLowerCase().includes(t.toLowerCase())).sort((e,o)=>{let i=`${e.symbol} ${e.name} ${e.address}`.toLowerCase(),n=`${o.symbol} ${o.name} ${o.address}`.toLowerCase(),r=i.indexOf(t.toLowerCase()),a=n.indexOf(t.toLowerCase());return r-a})}};U.styles=L,w3m_swap_select_token_view_decorate([(0,n.SB)()],U.prototype,"interval",void 0),w3m_swap_select_token_view_decorate([(0,n.SB)()],U.prototype,"targetToken",void 0),w3m_swap_select_token_view_decorate([(0,n.SB)()],U.prototype,"sourceToken",void 0),w3m_swap_select_token_view_decorate([(0,n.SB)()],U.prototype,"sourceTokenAmount",void 0),w3m_swap_select_token_view_decorate([(0,n.SB)()],U.prototype,"toToken",void 0),w3m_swap_select_token_view_decorate([(0,n.SB)()],U.prototype,"myTokensWithBalance",void 0),w3m_swap_select_token_view_decorate([(0,n.SB)()],U.prototype,"popularTokens",void 0),w3m_swap_select_token_view_decorate([(0,n.SB)()],U.prototype,"suggestedTokens",void 0),w3m_swap_select_token_view_decorate([(0,n.SB)()],U.prototype,"tokensLoading",void 0),w3m_swap_select_token_view_decorate([(0,n.SB)()],U.prototype,"searchValue",void 0),U=w3m_swap_select_token_view_decorate([(0,w.Mo)("w3m-swap-select-token-view")],U)},32835:function(e,t,o){var i=o(34615),n=o(38895);o(98088),o(31059),o(22584),o(85625),o(76630);var r=o(48113),a=o(25729),s=o(95636),l=s.iv`
  button {
    display: block;
    display: flex;
    align-items: center;
