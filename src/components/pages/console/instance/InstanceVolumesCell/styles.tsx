...
export const VolumesButton = styled.button`
...
export const VolumeRow = styled.button`
  ${tw`flex items-center gap-3 px-4 py-3 w-full text-left`};

  ${({ theme, disabled }) => css`
    &:hover {
      background-color: ${disabled ? 'transparent' : theme.color.purple2};
    }

    ${disabled && tw`opacity-60 cursor-default`}
  `}
`
