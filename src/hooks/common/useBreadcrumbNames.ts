...
const defaultNames = {
  ...
  [NAVIGATION_URLS.console.settings.domain.home]: '-',
  [`${NAVIGATION_URLS.console.settings.domain.home}/[hash]`]: '-',
  [NAVIGATION_URLS.console.settings.domain.new]: 'SETUP NEW DOMAIN',
...
export function useBreadcrumbNames(): UseBreadcrumbNamesReturn {
  ...
  names = useMemo(() => {
    ...
    return {
      ...
      [`${NAVIGATION_URLS.console.settings.domain.home}/[hash]`]: `DOMAINS / ${hashParam}`,
