...
const StyledTagContainer = styled.div(() => [tw`flex flex-wrap gap-y-4 gap-x-2.5`])

const StyledTag = styled(Tag).attrs(addClasses('tp-body1 fs-lg'))(() => [tw`m-0`])
  ...
  return (
    <>
            ...
            <Col xs={1} md={3}>
              <div tw="flex flex-col md:block">
                ...
                <div tw='flex flex-col md:flex-row gap-6 py-6 order-first items-start'>
                  <StyledH1Button onClick={handleScroll1}>Storage solutions<Icon name="arrow-right-long" tw='ml-4' /></StyledH1Button>
                  <StyledH1Button onClick={handleScroll2}>Computing solutions<Icon name="arrow-right-long" tw='ml-4' /></StyledH1Button>
                </div>
              </div>
            </Col>
          </Row>
        ...
        <Container>
          <Row xs={1} md={4} gap="1.5rem">
            <Col xs={1} md={3}>
              ...
              <p className='fs-md' tw="mt-0">With Aleph.im&apos;s computing services, you can process data quickly and securely using on-demand and persistent functions, virtual machine instances, and confidential VMs.</p>
            </Col>
          </Row>
        </Container>
      </section>
        ...
        <Container>
          <Row xs={1} md={2} gap="1.5rem">
            ...
            <Col>
              ...
              <p className='fs-md' tw="mb-12">Consider using the Aleph Indexer Framework for indexing blockchain data. It&apos;s open-source, multi-chain, and provides an easy-to-use solution for building high-performance, decentralized indexers on Aleph.im&apos;s infrastructure.</p>
              <Button forwardedAs='a' href="https://forms.clickup.com/f/q8g62-81/GW7WSGW5BUC0P2HRBE" target="_blank" kind='neon' variant='primary' size='big' color='main0' tw='my-6'>Get in touch with us</Button>
            </Col>
          </Row>
        </Container>
      </section>
      ...
      <section tw='px-0 py-20'>
        <Container>
          <h1 className='tp-h3' tw="mb-6 md:mb-16">Put your code to work</h1>
          <Row xs={1} md={2} xsGap="2.625rem" mdGap="1.5rem">
            <Col>
              <TextGradient as='h2' type='h7' color="main0" tw='mb-6'>How-to’s</TextGradient>
              <ul>
            ...
            <Col>
              <TextGradient as='h2' type='h7' color="main0" tw='mb-6'>Learn best practice</TextGradient>
              <ul>
      ...
      <section className='fx-noise-light' tw="px-0 py-20">
        <Container>
          <h1 className='tp-h4' tw="mb-12 md:mb-6">More resources</h1>
          <Row xs={1} md={6} xsGap="2.625rem" mdGap="1.5rem">
            <Col xs={1} md={3}>
              <h2 className='tp-h7' tw="mb-4">Documentation</h2>
              <StyledTagContainer>
            ...
            <Col xs={1} md={2} mdOffset={5}>
              <h2 className='tp-h7' tw="mb-4">Indexing Framework</h2>
              <StyledTagContainer>
